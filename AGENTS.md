...
- Before making any code or documentation change, open `<%=browser_logs%>`, review the most recent entries, and note any errors or warnings. If the file is missing, explicitly state that in your response.
